...
void main() {
  ...
  group('Recurrence Bug Reproduction', () {
    ...
    test(
      ...
      () async {
        ...
        // Assert
        // We expect multiple calls to zonedSchedule because getRecurringDates returns 14 days
        // and scheduleRecurringNotifications iterates over them.
        // And each call uses DateTimeComponents.time (implied by current implementation).
        ...
        // If this passes, it confirms the bug: multiple notifications are scheduled,
        // each repeating daily, leading to duplicate notifications.
      },
    );
